...
from io_features import write_features_to_csv, calculate_backbone_torsions


if __name__ == "__main__":
    """ 
    Calculates the backbone torsions (Ramachandran angles) for all selected residues. 
    """
    ...
    time, dist_names, distances = calculate_backbone_torsions(
